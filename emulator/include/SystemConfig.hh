...
#ifndef SRC_TESTEMULATOR_INCLUDE_SYSTEMCONFIG_HH_
#define SRC_TESTEMULATOR_INCLUDE_SYSTEMCONFIG_HH_
...
public:
	SystemConfig(const std::string& _name) : SimConfig(_name) {
...
#endif  // SRC_TESTEMULATOR_INCLUDE_SYSTEMCONFIG_HH_
